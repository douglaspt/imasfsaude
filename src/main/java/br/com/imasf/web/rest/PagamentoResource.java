...
/**
 * REST controller for managing {@link br.com.imasf.domain.Pagamento}.
 */
@RestController
@RequestMapping("/api")
public class PagamentoResource {
    ...
    public ResponseEntity<List<Pagamento>> getAllPagamentos(Pageable pageable) {
        log.debug("REST request to get a page of Pagamentos");
        Page<Pagamento> page = pagamentoService.findAll(pageable);
