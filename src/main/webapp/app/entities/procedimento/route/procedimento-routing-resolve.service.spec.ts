...
describe('Service Tests', () => {
  describe('Procedimento routing resolve service', () => {
    ...
    let resultProcedimento: IProcedimento | undefined;
    ...
    describe('resolve', () => {
      ...
      it('should return new IProcedimento if id is not provided', () => {
        // GIVEN
        ...
        expect(resultProcedimento).toEqual(new Procedimento());
      });
