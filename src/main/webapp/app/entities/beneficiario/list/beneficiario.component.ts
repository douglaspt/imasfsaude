...
export class BeneficiarioComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.beneficiarioService
      ...
      .subscribe(
        (res: HttpResponse<IBeneficiario[]>) => {
  ...
  trackId(index: number, item: IBeneficiario): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IBeneficiario[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
